...
if __name__=='__main__':
    ...
    parser.add_argument("-s", "--no_step_pickup", action="store_true", help="If set, will train for one more epoch. Otherwise, will train up to one epoch total (picking up where it left off)")  
    ...
    scheduler = LinearLR(optim,start_factor=lr_min/base_lr,end_factor=1,total_iters=warmup_steps)
