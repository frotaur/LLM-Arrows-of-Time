...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--tokenizer_name", help="Name of the tokenizer to use. Use prefix liek 'fr', 'en' or 'fi'")
    ...
    #state_path = 'runs/BackPerplexity/state/'+args.model_name+'.state'
    state_path = '/home/vassilis/bigdrive/vassilis/runs/state/'+args.model_name+'.state'
    backward=args.backward

    # Load the model using the specified path
    name, config, weights = MinGPT_Trainer.model_config_from_state(state_path,device=args.device)
