...
if __name__=='__main__':
    ...
    motherDataset = TokenTextBOSScrambled(h5_file=destination_path, attn_length=model_params['attn_length'], backwards=backwards,scrambling_seed=42)
